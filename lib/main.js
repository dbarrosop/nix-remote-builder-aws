...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const requestID = yield (0, aws_1.RequestSpotInstance)(client, name, ami, instanceType, securityGroupId, subnetId, sshKeyName, validUntil, diskName, diskSize, availabilityZone);
